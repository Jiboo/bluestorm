...
public class Nxt implements INxt {
    ...
    public boolean connect() throws IOException
    {
        ...
        catch(Exception e) { Log.e("bluetoothtest", "impossible de créer la socket"); }
        if(sock == null) return false;

        Log.d("bluetoothtest", "Connexion...");
        try { sock.connect(); }
        catch(Exception e) { Log.e("bluetoothtest", "connexion impossible"); return false; }
    ...
    public void close()
    {
        ...
        {
            try { sock.close(); }
            catch(Exception e) { Log.e("bluetoothtest", "connexion impossible"); }
        }
    }
